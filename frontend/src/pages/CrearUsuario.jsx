...
const CrearUsuario = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (secretKey !== "deadpool") {
      alert("Clave secreta incorrecta, no se puede crear el usuario");
      return;
    }

    const url = "http://localhost:8000/usuario/registro";
    const data = { apodo: username, contrasena: password, mail: email };
    ...
    if (response.detail == "Usuario ya registrado") {
